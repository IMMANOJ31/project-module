    ...
    <div class="form-container">
        ...
        <form action="registerUser" method="post">
            <div class="mb-3">
                ...
                <input type="text" name="firstName" class="form-control" placeholder="Enter First Name" onChange="firstNameValidation()" id="fName" required>
                <span id="fMsg" style="color:red";></span>
            </div>
            <div class="mb-3">
                <label>Last Name</label>
                <input type="text" name="lastName" class="form-control" placeholder="Enter Last Name" onChange="lastNameValidation()" id="lName" required>
                <span id="lMsg" style="color:red";></span>
            </div>
            <div class="mb-3">
                <label>Email</label>
                <input type="email" name="email" class="form-control" placeholder="Enter Email" onChange="emailValidation()" id="email" required>
                <span id="emailMsg" style="color:red";></span>
            </div>
            <div class="mb-3">
                <label>Phone Number</label>
                <input type="tel" name="phone" class="form-control" placeholder="Enter Phone Number" onChange="phoneValidation()" id="phone" required>
                <span id="phNo" style="color:red;"></span>
            </div>
            <div class="mb-3">
                <label>Date of Birth</label>
                <input type="date" name="dob" class="form-control" onChange="dobValidation()" id="dob" required>
            ...
            <div class="mb-3">
                <label>Country</label>
                <input type="text" name="country" class="form-control" placeholder="Enter Country" onChange="countryValidation()" id="country" required>
                <span id="countryMsg" style="color=red";></span>
            </div>
            <div class="mb-3">
                <label>State</label>
                <input type="text" name="state" class="form-control" placeholder="Enter State" onChange="stateValidation()" id="state" required>
                <span id="stateMsg" style="color:red";></span>
            </div>
            <div class="mb-3">
                <label>City</label>
                <input type="text" name="city" class="form-control" placeholder="Enter City" onChange="cityValidation()" id="city" required>
                <span id="cityMsg" style="color:red";></span>
            </div>
            <div class="mb-3">
                <label>Pincode</label>
                <input type="text" name="pincode" class="form-control" placeholder="Enter Pincode" onChange="pincodeValidation()" id="pincode" required>
                <span id="pincodeMsg" style="color:red";></span>
            </div>
            <div class="mb-3">
                <label>Password</label>
                <input type="password" name="password" class="form-control" placeholder="Enter Password" onChange="passwordValidation()" id="password" required>
                <span id="passwordMsg" style="color:red";></span>
            </div>
            <div class="mb-3">
                <label>Confirm Password</label>
                <input type="password" name="confirmPassword" class="form-control" placeholder="Confirm Password" onChange="confirmPasswordValidation()" id="confirmPassword" required>
